...
public class ColumnsTest extends NeoBaseTest {
    ...
    public void testFrom1() {
        ...
        Assert.assertEquals(Columns.of("`userName`", "`group`", "`name`", "`id`", "`dataBaseName`"), Columns.from(DemoEntity.class));
    }
    ...
    public void testFrom3() {
        ...
        show(Columns.from(DemoEntity.class, NamingChg.UNDERLINE));
        Columns expect = Columns.of("`user_name`", "`group`", "`name`", "`id`", "`data_base_name`");
        Assert.assertEquals(expect, Columns.from(DemoEntity.class, NamingChg.UNDERLINE));
    }

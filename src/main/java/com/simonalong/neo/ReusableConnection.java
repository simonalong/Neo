...
public final class ReusableConnection implements Connection {
    ...
    private ReusableConnection(){}

    public static ReusableConnection of(Connection connection) {
        ReusableConnection reConnection = new ReusableConnection();
        reConnection.connection = connection;
        return reConnection;
    }

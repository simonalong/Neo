...
//
//    /**
//     * key：为表名，value：为表中对应的数据
//     */
//    private Map<String, NeoMap> dataMap;
//
//    @Override
//    public int size() {
//        return 0;
...
//     * 全局的命名转换，默认不转换
//     */
//    private static NeoMap.NamingChg globalNaming = NeoMap.NamingChg.DEFAULT;
//    /**
//     * 本次的默认转换规则
//     */
//    @Setter
//    @Accessors(chain = true)
//    private NeoMap.NamingChg namingChg = NeoMap.NamingChg.DEFAULT;
//
//    public NeoMap() {
...
//     */
//    public static void setDefaultNamingChg(NeoMap.NamingChg namingChg) {
...
//            return data;
//        }
//        data.getDataMap().compute(DEFAULT_TABLE, (k, v)->{
//            if(null == v){
...
//        return from(object, NeoMap.NamingChg.DEFAULT, new ArrayList<>(), new ArrayList<>());
//    }
//
//    /**
//     * 对象转换为NeoMap
...
//     * @return 转换之后的NeoMap
//     */
//    public static NeoMap from(Object object, NeoMap.NamingChg namingChg) {
...
//        return from(object, NeoMap.NamingChg.DEFAULT, Arrays.asList(columnsNames), new ArrayList<>());
//    }
//
...
//    }
//
//    public static NeoMap from(Object object, Columns columns, NeoMap.NamingChg namingChg) {
//        if (Columns.isEmpty(columns)) {
...
//        return from(object, NeoMap.NamingChg.DEFAULT, Arrays.asList(fields), new ArrayList<>());
//    }
//
//    /**
//     * 指定包括的属性进行对象转换为NeoMap
...
//     * @return 转换之后的NeoMap
//     */
//    public static NeoMap fromInclude(Object object, NeoMap.NamingChg namingChg, String... fields) {
...
//        return from(object, NeoMap.NamingChg.DEFAULT, new ArrayList<>(), Arrays.asList(fields));
//    }
//
//    /**
//     * 指定排除的属性进行对象转换为NeoMap
...
//     * @return 转换之后的NeoMap
//     */
//    static NeoMap fromExclude(Object object, NeoMap.NamingChg namingChg, String... fields) {
...
//     */
//    @SuppressWarnings("unchecked")
//    private static NeoMap from(Object object, NeoMap.NamingChg namingChg, List<String> inFieldList, List<String> exFieldList) {
...
//     */
//    public static NeoMap fromMap(NeoMap sourceMap, NeoMap.NamingChg namingChg) {
//        NeoMap targetMap = NeoMap.of();
//        sourceMap.stream().forEach(c -> targetMap.defaultMap().putIfAbsent(namingChg.smallCamelToOther(c.getKey()), c.getValue()));
//        return targetMap;
//    }
//
//    /**
...
//                    if (null != value) {
//                        neoMap.defaultMap().putIfAbsent(neoMap.namingChg(object.getClass(), f, false), value);
//                    }
...
//    }
//
//    public static <T> List<T> asArray(List<NeoMap> neoMaps, NeoMap.NamingChg namingChg, Class<T> tClass) {
//        if (null == neoMaps || neoMaps.isEmpty()) {
//            return new ArrayList<>();
//        }
//
...
//        return fromArray(dataList, NeoMap.NamingChg.UNDERLINE, null);
//    }
//
//    public static <T> List<NeoMap> fromArray(List<T> dataList, NeoMap.NamingChg namingChg, Columns columns) {
//        if (null == dataList || dataList.isEmpty()) {
//            return new ArrayList<>();
//        }
...
//    }
//
//    public static <T> List<NeoMap> fromArray(List<T> dataList, NeoMap.NamingChg namingChg) {
...
//     * @return 转换之后的字符
//     */
//    public static String dbToJavaStr(String source, NeoMap.NamingChg namingChg) {
...
//     * @return 转换后的类型
//     */
//    public NeoMap keyChgToSmallCamelFrom(NeoMap.NamingChg namingChg){
...
//     * @return 转换后的类型
//     */
//    public NeoMap keyChgFromSmallCamelTo(NeoMap.NamingChg namingChg){
//        NeoMap neoMap = NeoMap.of();
...
//        if (value instanceof NeoMap.EntryValue) {
//            Column column = f.getDeclaredAnnotation(Column.class);
//            if (null != column) {
//                String tableName = column.table();
//                return NeoMap.EntryValue.class.cast(value).getTableValues().stream()
//                    .filter(n -> n.getKey().equals(tableName))
//                    .map(NeoMap.Node::getValue)
...
//    }
//
//    public Stream<Entry<String, Map<String, Object>>> stream() {
...
//                    }
//                }
//                if (containsKey(tableName, columnName)) {
//                    return columnName;
//                }
//            } else {
//                return columnName;
...
//            return false;
//        }
//        return containsKey(DEFAULT_TABLE, key);
//    }
//
...
//    @Override
//    public Object get(Object key) {
//        return getTableMap(DEFAULT_TABLE).get(key);
//    }
//
...
//    }
//
//    public Map<String, Object> getTableMap(String tableName) {
//        if (dataMap.containsKey(tableName)) {
...
//        } else if (size == 1){
//            if (containsTable(DEFAULT_TABLE)){
//                return JSON.toJSONString(dataMap.get(DEFAULT_TABLE));
//            }
//        }
//
...
//         */
//        @Getter
//        private List<NeoMap.Node<String, Object>> tableValues = new ArrayList<>();
//
//        public EntryValue(Object object){
//            tableValues.add(new NeoMap.Node<>(DEFAULT_TABLE, object));
//        }
//
//        public EntryValue(String tableName, Object object){
//            tableValues.add(new NeoMap.Node<>(tableNameChg(tableName), object));
//        }
//
//        public NeoMap.EntryValue addTable(String tableName, Object object){
//            tableValues.add(new NeoMap.Node<>(tableNameChg(tableName), object));
//            return this;
//        }
//
...
//        @Override
//        public Object clone() {
//            NeoMap.EntryValue clone = new NeoMap.EntryValue();
